...
import (
	...
	"github.com/eddcp/full-cycle/hexagonal-architecture-go/adapters/cli"
	mock_application "github.com/eddcp/full-cycle/hexagonal-architecture-go/application/mocks"
